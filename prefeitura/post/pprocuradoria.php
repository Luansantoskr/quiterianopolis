						...
						<div class="inner">
							...
							<h3>Informações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>CNPJ</label>
											<input type="text" name="cnpjProcuradoria">
										<label>Telefone</label>
											<input type="text" name="telefoneProcuradoria">
										<label>Email</label>
											<input type="text" name="emailProcuradoria">
										<label>Horário de funcionamento</label>
											<input type="text" name="funcionamentoProcuradoria">
										<label>Endereço</label>
											<input type="text" name="enderecoProcuradoria">
										<label>Nome</label>
											<input type="text" name="nomeProcuradoria">
										<label>Cargo</label>
											<input type="text" name="cargoProcuradoria">
										<label>período</label>
											<input type="text" name="periodoProcuradoria">
										<label>Amparo legal</label>
											<input type="text" name="amparoProcuradoria">
										<label>Matrícula</label>
											<input type="text" name="matriculaProcuradoria"><br>
								...
								<h3>Ordenadores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeOrdenadorProcuradoria">
										<label>Data início</label>
											<input type="text" name="dataOrdenadorProcuradoria">
										<label>Data fim</label>
											<input type="text" name="dataOrdenadorProcuradoria">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Portarias</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloPortariaProcuradoria">
										<label>Conteúdo</label>
											<input type="text" name="conteudoPortariaProcuradoria">
										<label>Data</label>
											<input type="text" name="dataPortariaProcuradoria">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Contratos</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloContratoProcuradoria">
										<label>Conteúdo</label>
											<input type="text" name="conteudoContratoProcuradoria">
										<label>Data</label>
								...
								<h3>Licitações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloLicitacaoProcuradoria">
										<label>Conteúdo</label>
											<input type="text" name="conteudoLicitacaoProcuradoria">
										<label>Data</label>
											<input type="text" name="dataLicitacaoProcuradoria">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
