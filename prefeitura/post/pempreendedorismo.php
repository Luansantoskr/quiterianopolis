						...
						<div class="inner">
							...
							<h3>Informações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>CNPJ</label>
											<input type="text" name="cnpjEmpreende">
										<label>Telefone</label>
											<input type="text" id="telefone3" name="telefoneEmpreende">
										<label>Email</label>
											<input type="text" name="emailEmpreende">
										<label>Horário de funcionamento</label>
											<input type="text" name="funcionamentoEmpreende">
										<label>Endereço</label>
											<input type="text" name="enderecoEmpreende">
										<label>Nome</label>
											<input type="text" name="nomeEmpreende">
										<label>Cargo</label>
											<input type="text" name="cargoEmpreende">
										<label>período</label>
											<input type="text" name="periodoEmpreende">
										<label>Amparo legal</label>
											<input type="text" name="amparoEmpreende">
										<label>Matrícula</label>
											<input type="text" name="matriculaEmpreende"><br>
								...
								<h3>Ex gestores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeGPl">
										<label>Data início</label>
											<input type="text" id="dataInpl" name="dataInpl">
										<label>Data fim</label>
											<input type="text" name="dataFipl">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Ordenadores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeGPl1">
										<label>Data início</label>
											<input type="text" id="dataInpl" name="dataInpl1">
										<label>Data fim</label>
											<input type="text" name="dataFipl1">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Portarias</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloPl">
										<label>Conteúdo</label>
											<input type="text" name="conteudoPl">
										<label>Data</label>
											<input type="text" name="dataPl1">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Contratos</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloPl2">
										<label>Conteúdo</label>
											<input type="text" name="conteudoPl2">
										<label>Data</label>
											<input type="text" name="dataPl2">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
