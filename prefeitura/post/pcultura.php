						...
						<div class="inner">
							...
							<h3>Informações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>CNPJ</label>
											<input type="text" name="cnpj_cultura">
										<label>Telefone</label>
											<input type="text" name="telefone_cultura">
										<label>Email</label>
											<input type="text" name="email_cultura">
										<label>Horário de funcionamento</label>
											<input type="text" name="funcionamento_cultura">
										<label>Endereço</label>
											<input type="text" name="endereco_cultura">
										<label>Nome</label>
											<input type="text" name="nome_cultura">
										<label>Cargo</label>
											<input type="text" name="cargo_cultura">
										<label>período</label>
											<input type="text" name="periodo_cultura">
										<label>Amparo legal</label>
											<input type="text" name="amparo_cultura">
										<label>Matrícula</label>
											<input type="text" name="matricula_cultura"><br>
								...
								<h3>Ex gestores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeExCultura">
										<label>Data início</label>
											<input type="text" name="dataInicioCultura">
										<label>Data fim</label>
											<input type="text" name="dataFimCultura"><br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Ordenadores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeOrdenadoresCultura">
										<label>Data início</label>
											<input type="text" name="dataInicioOrdenadoresCultura">
										<label>Data fim</label>
											<input type="text" name="dataFimOrdenadoresCultura">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Portarias</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloPortariaCultura">
										<label>Conteúdo</label>
											<input type="text" name="conteudoPortariaCultura">
										<label>Data</label>
											<input type="text" name="dataPortariaCultura"><br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Contratos</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloContratoCultura">
										<label>Conteúdo</label>
											<input type="text" name="conteudoContratoCultura">
										<label>Data</label>
											<input type="text" name="dataContratoCultura"><br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Licitações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloLicitacaoCultura">
										<label>Conteúdo</label>
											<input type="text" name="conteudoLicitacaoCultura">
										<label>Data</label>
											<input type="text" name="dataLicitacaoCultura">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
