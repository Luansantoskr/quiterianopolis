						...
						<div class="inner">
							...
							<h3>Informações</h3>
								...
								<h3>Ex gestores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeExPlanejamento">
										<label>Data início</label>
											<input type="text" name="dataInicioExPlanajamento">
										<label>Data fim</label>
											<input type="text" name="dataFimExPlanejamento"><br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Ordenadores</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Nome</label>
											<input type="text" name="nomeOrdenadoresPlanejamento">
										<label>Data início</label>
											<input type="text" name="dataInicioOrdenadoresPlanejamento">
										<label>Data fim</label>
											<input type="text" name="dataFimOrdenadoresPlanejamento">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
