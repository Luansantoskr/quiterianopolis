			...
			<div id="wrapper">
					...
					<div id="main">
						<div class="inner">
							...
							<!-- Banner -->
							<section>
									<form action="../classes/post_diario.php" method="post">
										<label>Título do diário</label>
											<input type="text" name="titulo_diario">
										<label>Conteudo do diário </label>
											<input type="text" name="conteudo_diario"><br>
										<div>
