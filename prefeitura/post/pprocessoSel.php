						...
						<div class="inner">
							...
							<section>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título do processo seletivo</label>
											<input type="text" name="tituloProcesso">
										<label>Conteúdo do processo seletivo</label>
											<input type="text" name="conteudoProcesso">
										<label>Data do processo seletivo</label>
											<input type="text" name="dataProcesso"><br>
