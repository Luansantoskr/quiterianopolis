						...
						<div class="inner">
							...
							<h3>Informações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>CNPJ</label>
											<input type="text" name="cnpj6">
										<label>Telefone</label>
											<input type="text" name="telefone6">
										<label>Email</label>
											<input type="text" name="email6">
										<label>Horário de funcionamento</label>
											<input type="text" name="funcionamento6">
										<label>Endereço</label>
											<input type="text" name="endereco6">
										<label>Nome</label>
											<input type="text" name="nome6">
										<label>Cargo</label>
											<input type="text" name="cargo6">
										<label>período</label>
											<input type="text" name="periodo6">
										<label>Amparo legal</label>
											<input type="text" name="amparo6">
										<label>Matrícula</label>
											<input type="text" name="matricula6"><br>
								...
								<h3>Portarias</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloPortariaAssis">
										<label>Conteúdo</label>
											<input type="text" name="conteudoAssis">
										<label>Data</label>
											<input type="text" name="dataAssis">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Contratos</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloContratosAssis">
										<label>Conteúdo</label>
											<input type="text" name="conteudoContratosAssis">
										<label>Data</label>
											<input type="text" name="dataContratosAssis">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
								<section>
								<h3>Licitações</h3>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título</label>
											<input type="text" name="tituloLicitacoesSocial">
										<label>Conteúdo</label>
											<input type="text" name="conteudoLicitacoesSocial">
										<label>Data</label>
											<input type="text" name="dataLicitacoesSocial">	<br>								
										<input type="submite" class="button button2" value="Adicionar">
									</form> 
                                </section>
