							...
							<section>
									<form action="postar.php" enctype="multipart/form-data">
										<label>Título da portaria</label>
											<input type="text" name="tituloPortaria">
										<label>Conteúdo da portaria</label>
											<input type="text" name="conteudoPortaria">
										<label>Data da portaria</label>
											<input type="text" name="dataPortaria">
											<label>Agente: </label>
											<input type="text" name="agentePortaria">
										<label>Cargo</label>
											<input type="text" name="cargoAgente">
										<label>Secretaria</label>
											<input type="text" name="secretariaPortaria"><br>
